...
builder.Services.AddScoped<IMusicFakerAdapter, MusicFakerAdapter>();
builder.Services.AddScoped<INameFakerAdapter, NameFakerAdapter>();
builder.Services.AddScoped<IPersonFakerAdapter, PersonFakerAdapter>();
...
builder.Services.AddScoped<IMusicDatasetService, MusicDatasetService>();
builder.Services.AddScoped<INameDatasetService, NameDatasetService>();
builder.Services.AddScoped<IPersonDatasetService, PersonDatasetService>();
